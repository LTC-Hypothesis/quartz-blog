...
$$
\begin{cases} \dfrac{\mathrm{d}x_1(t)}{\mathrm{d}t} + \dfrac{1}{C_1}\left(\dfrac{1}{R_1} + \dfrac{1}{R_2}\right)x_1(t) - \dfrac{1}{R_2C_1}x_2(t) = \dfrac{1}{R_1C_1}E(t), \\[1em] \dfrac{\mathrm{d}x_2(t)}{\mathrm{d}t} - \dfrac{1}{R_2C_2}x_1(t) + \dfrac{1}{R_2C_2}x_2(t) = 0. \end{cases}\tag{3}
$$
```
