...
```ad-proposition
title:Expectation and covariance function of $(*2)$
...
```ad-def
title:Linear equation associated with $m(t)$ and $V(t)$ 
We have 
$$
\begin{cases}
...
```ad-proposition
title:The controllable equivalent condition
...
**QED**
```ad-thm
title:Solution of constant case
...
```ad-def
title:Brownian bridge from $a$ to $b$
