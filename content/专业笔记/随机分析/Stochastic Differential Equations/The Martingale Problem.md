...
```ad-def
title:Second-order differential operator
...
```ad-proposition
title:Martingale characterization of Brownian motion
...
```ad-def
title:Local martingale problem (LMP)
...
# Existence
```ad-thm
title:Skorohod, Stroock, Varadhan. (Existence)
Consider the SDE 
$$
...
# Uniqueness
```ad-thm
title:Stroock & Varadhan. (Uniqueness)
