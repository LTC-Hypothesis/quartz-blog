...
```ad-def
title:Stopping time and optional times
...
```ad-proposition
title:Properties of stopping time
...
```ad-proposition
title:Properties of hitting time
...
**QED**
```ad-proposition
title:Arithmetic of stopping time
...
**QED**
```ad-proposition
title:Limit arithmetic of stopping time
...
**QED**
```ad-def
title:Events determined prior to the stopping time
...
```ad-def
title:Events determined immediately after the optional time 
