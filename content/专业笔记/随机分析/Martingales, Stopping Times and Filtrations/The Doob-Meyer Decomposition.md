...
> [!def] Integrable of increasing sequence
...
> [!def] Martingale transform / discrete version of stochastic integral
...
> [!proposition] Doob decomposition (discrete)
...
> [!def] Continuous increasing process
...
> [!def] Natural of continuous version
...
> converves to $\mathbb{E}[A | \mathcal{G}]$ weakly in $L^1$.
...
> [!done] Done for first inequality
...
> [!done] Done for second inequality
...
> [!done] Done for third inequality
