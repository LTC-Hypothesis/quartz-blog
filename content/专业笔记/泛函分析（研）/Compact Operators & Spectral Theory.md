...
```ad-thm
title:Compact operator can be approximated by operator with finite rank
...
```ad-proposition
title:Composition of compact operator and linear operator
...
**QED**
```ad-thm
title:Schauder (characterization with dual operator)
...
```ad-def
title:Spectrum, eigenvalue(e-value) and eigenspace(e-space) 
